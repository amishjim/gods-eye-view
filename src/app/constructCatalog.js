...
import { createApplicationPublicIncidents } from './layers/publicIncidents.js';
  ...
  try {
    ...
    const catalog = createLayerCatalog(
      [
        ...
        createApplicationPublicIncidents({
          source: sources.publicIncidents,
        }),
